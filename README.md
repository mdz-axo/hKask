...
**Version:** v0.22.0 | **Status:** Phase 8 complete — Distillation done, operational hardening in progress
...
- `docs/architecture/hKask-architecture-master.md` — Architecture index (v0.22.0)
