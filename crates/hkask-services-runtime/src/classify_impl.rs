...
/// Model configured via `HKASK_CLASSIFIER_MODEL_A` → `registry/classify/hmem-extractor.yaml`.
...
/// Model is determined by `HKASK_CLASSIFIER_MODEL_A` env var / settings, falling back
