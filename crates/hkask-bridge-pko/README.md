...
Part of the dual-axis ontological framework (P5.4): every MCP server uses this crate alongside `hkask-bridge-dublincore` (state axis). Shared by all 15 MCP servers.
