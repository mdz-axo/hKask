...
impl CostModel {
    ...
    /// Baseten — ~$0.85/hr for comparable GPU, ~4 min setup
    pub fn baseten() -> Self {
        Self {
            provider: ProviderId::Baseten,
            gpu_hourly_rate: 0.85,
...
impl ProviderCapability {
    ...
    /// Baseten supports LoRA composition.
    pub fn baseten() -> Self {
        Self {
            supports_lora_composition: true,
...
mod tests {
    ...
    fn static_models_integrity() {
        ...
        let bt = CostModel::baseten();
        assert_eq!(bt.provider, ProviderId::Baseten);
    }
}
