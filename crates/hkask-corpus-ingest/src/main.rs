//! Company Researcher corpus tool — utilities for the capabilities and research
//! literature pipeline. Pipeline logic lives in the MCP docproc server tools;
//! this binary provides CLI utilities (purge-qa, ocr) and transitional
//! build-prompts / generate-qa / ingest-qa commands.
//!
