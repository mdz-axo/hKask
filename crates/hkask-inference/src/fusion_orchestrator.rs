...
fn skill_prompt(skill: &FusionSkill) -> &'static str {
    match skill {
        ...
        FusionSkill::RustExpertise => {
            "Rust Expertise: Type-driven design — let the type system prove invariants. \
             Ownership as architecture — scopes define lifetimes, borrowing defines \
             relationships. Fearless refactoring — the compiler is your design partner."
        }
    }
}
