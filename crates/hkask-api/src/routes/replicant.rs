//! Replicant API — list replicants for multi-replicant users.
//!
//! REQ: DEP-310 — P1 User Sovereignty: user can view their replicants.
...
/// GET /api/v1/replicants — list replicants for the authenticated user.
...
pub fn replicant_router() -> utoipa_axum::router::OpenApiRouter<ApiState> {
    ...
    OpenApiRouter::new().route("/api/v1/replicants", axum::routing::get(list_replicants))
}
