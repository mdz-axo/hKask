...
//!
//! - `GET /api/models` — List all available models (DeepInfra, fal.ai, Together AI, OpenRouter)
...
///
/// Queries DeepInfra, fal.ai, Together AI, and OpenRouter and returns metadata for each
