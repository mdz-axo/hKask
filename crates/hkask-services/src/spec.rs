...
use hkask_storage::{SpecStore, TripleStore};
...
impl SpecService {
    ...
    pub fn contract_audit(
        ...
        workspace_root: &str,
    ) -> Result<Vec<hkask_test_harness::test_runner::ContractAudit>, ServiceError> {
    ...
    pub fn test_run(
        crate_name: &str,
        workspace_root: &str,
    ) -> Result<hkask_test_harness::test_runner::ContractTestResult, ServiceError> {
    ...
    pub fn emit_test_violations(
        ...
        violations: &[hkask_test_harness::test_runner::ContractViolation],
    ) {
        for _v in violations {
            // CNS emission for contract violations tracked via event sink
            let _ = event_sink;
        }
    }
}
