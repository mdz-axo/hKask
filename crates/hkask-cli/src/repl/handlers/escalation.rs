...
pub(crate) fn handle_escalations(state: &super::super::ReplState) {
    match state
        .service_context
        .governance()
...
pub(crate) fn handle_resolve(arg1: &str, state: &super::super::ReplState) {
    if arg1.is_empty() {
...
pub(crate) fn handle_dismiss(arg1: &str, state: &super::super::ReplState) {
    if arg1.is_empty() {
