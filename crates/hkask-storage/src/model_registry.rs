//! Model Registry — SQLite storage for LLM model metadata
...
/// Model category for selection intelligence
...
impl ModelCategory {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            ModelCategory::Categorization => "categorization",
            ModelCategory::Embedding => "embedding",
            ModelCategory::Specialist => "specialist",
        }
    }
}
