...
//!   {agent_name}/
//!     # ── Core databases ───────────────────────────────────────────
//!     pod.db            Per-pod SQLCipher database (TripleStore, EmbeddingStore, CNS)
...
//! | agent.yaml  | YAML file      | AgentRegistryLoader (self-contained)    | 🔧 not created yet |
//!
...
/// Pod database — TripleStore, EmbeddingStore, CNS events.
