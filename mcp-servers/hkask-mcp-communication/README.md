...
| `invite_agent` | Invite another userpod to a Matrix room |
...
| `HKASK_MCP_HOST` | UserPod identity for P4 gate verification | `anonymous` |

## Startup

The server verifies three P4 gates at startup before accepting tool invocations:
1. Authentication (is this userpod authenticated?)
2. Assignment (is this userpod assigned to the communication role?)
3. Capability (does this userpod hold OCAP tokens for these tools?)
