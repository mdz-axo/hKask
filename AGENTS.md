...
> **Canonical source:** [`docs/architecture/PRINCIPLES.md`](docs/architecture/PRINCIPLES.md) §1.4 — that document lists all 20 CNS span namespaces (15 canonical + 5 hierarchical). The table below shows only the spans most relevant to CNS loop wiring.
