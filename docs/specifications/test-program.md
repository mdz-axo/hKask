...
| **diagnose** | Root cause over symptoms; feedback loop construction | Observability (feedback loop), Trust (root cause), Lifecycle (regression test as evolution gate) | `diagnose` (KnowAct), `recognize` (KnowAct) |
