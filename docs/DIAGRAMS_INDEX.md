...
| DIAG-IC-006 | LLM Routing and Failover (Inference Router — OM/DI/FA/TG/RP/BT) | [MDS.md](architecture/core/MDS.md) §2.5 | `crates/hkask-mcp/src/runtime.rs`, `crates/hkask-mcp/src/security.rs` | ✅ VERIFIED |
