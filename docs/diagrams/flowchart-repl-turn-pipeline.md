...
- **CNS update:** The `on_cns_update` closure runs after the loop exits, checking algedonic alerts and ticking the LoopSystem. This is the cybernetic feedback path from the turn back to the regulator.
