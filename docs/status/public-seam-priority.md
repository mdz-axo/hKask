...
**Generated:** 2026-06-16T14:57:08Z
...
|---|-------|------|------|--------|----------|----------|
| 1 | hkask-agents | fn | `acp_runtime` | hkask-agents::pod::manager | crates/hkask-agents/src/pod/manager.rs:421 | Core Logic |
| 2 | hkask-agents | fn | `activate` | hkask-agents::pod::mod | crates/hkask-agents/src/pod/mod.rs:322 | Core Logic |
| 3 | hkask-agents | fn | `calibrate_from_history` | hkask-agents::curator_agent::spec_curator | crates/hkask-agents/src/curator_agent/spec_curator.rs:72 | Core Logic |
| 4 | hkask-agents | fn | `can_access` | hkask-agents::sovereignty | crates/hkask-agents/src/sovereignty.rs:105 | Core Logic |
| 5 | hkask-agents | fn | `cancel_token` | hkask-agents::loop_system | crates/hkask-agents/src/loop_system.rs:160 | Core Logic |
| 6 | hkask-agents | fn | `can_transition_to` | hkask-agents::pod::types | crates/hkask-agents/src/pod/types.rs:59 | Core Logic |
| 7 | hkask-agents | fn | `capability_resources` | hkask-agents::pod::types | crates/hkask-agents/src/pod/types.rs:168 | Core Logic |
| 8 | hkask-agents | fn | `check_conditions` | hkask-agents::curator_agent::metacognition | crates/hkask-agents/src/curator_agent/metacognition.rs:121 | Core Logic |
| 9 | hkask-agents | fn | `check_operation` | hkask-agents::sovereignty | crates/hkask-agents/src/sovereignty.rs:123 | Core Logic |
| 10 | hkask-agents | fn | `check_persona_constraints` | hkask-agents::curator::persona_filter | crates/hkask-agents/src/curator/persona_filter.rs:32 | Core Logic |
| 11 | hkask-agents | fn | `check_sovereignty` | hkask-agents::curator_agent::spec_curator | crates/hkask-agents/src/curator_agent/spec_curator.rs:185 | Core Logic |
| 12 | hkask-agents | fn | `check_sovereignty` | hkask-agents::pod::mod | crates/hkask-agents/src/pod/mod.rs:610 | Core Logic |
| 13 | hkask-agents | fn | `classified_episodic` | hkask-agents::ports::memory_storage | crates/hkask-agents/src/ports/memory_storage.rs:130 | Core Logic |
| 14 | hkask-agents | fn | `context` | hkask-agents::curator::curation_loop | crates/hkask-agents/src/curator/curation_loop.rs:115 | Core Logic |
| 15 | hkask-agents | fn | `context` | hkask-agents::curator_agent::mod | crates/hkask-agents/src/curator_agent/mod.rs:176 | Core Logic |
| 16 | hkask-agents | fn | `correlation_id` | hkask-agents::acp::mod | crates/hkask-agents/src/acp/mod.rs:280 | Core Logic |
| 17 | hkask-agents | fn | `curation_loop` | hkask-agents::curator_agent::mod | crates/hkask-agents/src/curator_agent/mod.rs:158 | Core Logic |
| 18 | hkask-agents | fn | `curator_handle` | hkask-agents::curator::curation_loop | crates/hkask-agents/src/curator/curation_loop.rs:127 | Core Logic |
| 19 | hkask-agents | fn | `deactivate` | hkask-agents::pod::mod | crates/hkask-agents/src/pod/mod.rs:360 | Core Logic |
| 20 | hkask-agents | fn | `decompose_prompt` | hkask-agents::prompt_analysis | crates/hkask-agents/src/prompt_analysis.rs:584 | Core Logic |
| 21 | hkask-agents | fn | `default_tick_interval` | hkask-agents::loop_system | crates/hkask-agents/src/loop_system.rs:63 | Core Logic |
| 22 | hkask-agents | fn | `delegate` | hkask-agents::pod::mod | crates/hkask-agents/src/pod/mod.rs:401 | Core Logic |
...
| 27 | hkask-agents | fn | `enter_chat_mode` | hkask-agents::pod::mod | crates/hkask-agents/src/pod/mod.rs:491 | Core Logic |
| 28 | hkask-agents | fn | `enter_server_mode` | hkask-agents::pod::mod | crates/hkask-agents/src/pod/mod.rs:458 | Core Logic |
| 29 | hkask-agents | fn | `episodic` | hkask-agents::ports::memory_storage | crates/hkask-agents/src/ports/memory_storage.rs:166 | Core Logic |
| 30 | hkask-agents | fn | `episodic` | hkask-agents::ports::memory_storage | crates/hkask-agents/src/ports/memory_storage.rs:77 | Core Logic |
...
| 33 | hkask-agents | fn | `exit_mode` | hkask-agents::pod::mod | crates/hkask-agents/src/pod/mod.rs:515 | Core Logic |
...
| 36 | hkask-agents | fn | `generate_summary` | hkask-agents::curator_agent::metacognition | crates/hkask-agents/src/curator_agent/metacognition.rs:277 | Core Logic |
| 37 | hkask-agents | fn | `grant` | hkask-agents::consent | crates/hkask-agents/src/consent.rs:66 | Core Logic |
| 38 | hkask-agents | fn | `grant_consent` | hkask-agents::consent | crates/hkask-agents/src/consent.rs:234 | Core Logic |
| 39 | hkask-agents | fn | `handle` | hkask-agents::curator::context | crates/hkask-agents/src/curator/context.rs:91 | Core Logic |
| 40 | hkask-agents | fn | `inference_port` | hkask-agents::pod::context | crates/hkask-agents/src/pod/context.rs:152 | Core Logic |
| 41 | hkask-agents | fn | `inference_port` | hkask-agents::pod::manager | crates/hkask-agents/src/pod/manager.rs:191 | Core Logic |
| 42 | hkask-agents | fn | `in_memory` | hkask-agents::adapters::memory_loop_adapter | crates/hkask-agents/src/adapters/memory_loop_adapter.rs:162 | Core Logic |
| 43 | hkask-agents | fn | `in_memory_unchecked` | hkask-agents::adapters::memory_loop_adapter | crates/hkask-agents/src/adapters/memory_loop_adapter.rs:177 | Core Logic |
| 44 | hkask-agents | fn | `invoke_tool` | hkask-agents::pod::context | crates/hkask-agents/src/pod/context.rs:334 | Core Logic |
| 45 | hkask-agents | fn | `message_type` | hkask-agents::acp::mod | crates/hkask-agents/src/acp/mod.rs:294 | Core Logic |
| 46 | hkask-agents | fn | `metacognition` | hkask-agents::curator_agent::mod | crates/hkask-agents/src/curator_agent/mod.rs:167 | Core Logic |
...
| 50 | hkask-agents | fn | `restore_cursor` | hkask-agents::curator::curation_loop | crates/hkask-agents/src/curator/curation_loop.rs:141 | Core Logic |
| 51 | hkask-agents | fn | `revoke` | hkask-agents::consent | crates/hkask-agents/src/consent.rs:76 | Core Logic |
| 52 | hkask-agents | fn | `revoke_consent` | hkask-agents::consent | crates/hkask-agents/src/consent.rs:265 | Core Logic |
| 53 | hkask-agents | fn | `semantic` | hkask-agents::ports::memory_storage | crates/hkask-agents/src/ports/memory_storage.rs:102 | Core Logic |
| 54 | hkask-agents | fn | `semantic` | hkask-agents::ports::memory_storage | crates/hkask-agents/src/ports/memory_storage.rs:180 | Core Logic |
| 55 | hkask-agents | fn | `semantic_storage_usage` | hkask-agents::pod::context | crates/hkask-agents/src/pod/context.rs:315 | Core Logic |
| 56 | hkask-agents | fn | `spec_curator` | hkask-agents::curator_agent::mod | crates/hkask-agents/src/curator_agent/mod.rs:188 | Core Logic |
| 57 | hkask-agents | fn | `state` | hkask-agents::pod::mod | crates/hkask-agents/src/pod/mod.rs:437 | Core Logic |
| 58 | hkask-agents | fn | `store` | hkask-agents::registry_loader | crates/hkask-agents/src/registry_loader.rs:385 | Core Logic |
...
| 62 | hkask-agents | fn | `strip_forbidden_patterns` | hkask-agents::curator::persona_filter | crates/hkask-agents/src/curator/persona_filter.rs:68 | Core Logic |
...
| 65 | hkask-agents | fn | `validate_fields` | hkask-agents::pod::types | crates/hkask-agents/src/pod/types.rs:176 | Core Logic |
| 66 | hkask-agents | fn | `visit` | hkask-agents::acp::mod | crates/hkask-agents/src/acp/mod.rs:215 | Core Logic |
| 67 | hkask-agents | fn | `voice_description` | hkask-agents::pod::mod | crates/hkask-agents/src/pod/mod.rs:573 | Core Logic |
| 68 | hkask-agents | fn | `webid` | hkask-agents::pod::types | crates/hkask-agents/src/pod/types.rs:159 | Core Logic |
