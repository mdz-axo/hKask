...
| **P1-11** | Energy-use tracking simplification + security hardening | Dev + CNS | High | 📋 Partial | Audit complete: 7 semantic operations across 23 surfaces mapped. 3 recommendations: (a) remove CyberneticsLoop pass-through, (b) add EnergyBudget tamper-evidence, (c) audit float determinism. Implementation deferred. Audit notes merged into `docs/architecture/core/PRINCIPLES.md`. |
