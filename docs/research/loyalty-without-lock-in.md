...
5. **Minimum viable federation.** What is the smallest set of artifacts that must carry 5W1H answers for federation to be meaningful? If only skills carry full 5W1H but triples carry only partial answers, the curator's diagnostic capability is limited.
