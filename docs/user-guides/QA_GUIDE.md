...
2. Loads the `qa-triage` classifier config from `$HKASK_REGISTRY_DIR/classify/qa-triage.yaml`
...
Stored in `$HKASK_REGISTRY_DIR/classify/` as YAML files. Two standard configs:
