...
| `hkask-services-context` | 2 | `AgentService`, `PerAgentMemory` | Shared agent context and per-agent memory handle. Bottleneck type — all other services route through it. |
