...
- **Model specification:** Templates can specify a model override via `{# model: OM/qwen3:14b #}` directive on line 1. Parsed before rendering, passed to `InferencePort::generate_with_model`.
