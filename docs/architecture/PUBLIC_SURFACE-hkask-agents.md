...
2. **ACP integration** — `AcpRuntime`, `AcpError`, and ACP adapters are public for registration and capability management.
...
- **Trait-based ports:** `AcpPort`, `MCPRuntimePort` enable testability without exposing implementation details.
