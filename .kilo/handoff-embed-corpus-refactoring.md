...
| 26 | Update `hemingway-style-synthesizer.yaml` manifest (v0.23.0, inputs, fixed steps) | ✅ Done |
| 27 | Fix `mcp_doc_extract.yaml` (`hkask-cns` → `hkask-mcp-cns`, v0.23.0) | ✅ Done |
...
| manifest | `registry/manifests/hemingway-style-synthesizer.yaml` | Process manifest v0.23.0 |
| manifest | `registry/manifests/mcp_doc_extract.yaml` | Fixed server name + v0.23.0 |
